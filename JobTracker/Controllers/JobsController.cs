...
namespace JobTracker.Controllers
{
    public class JobsController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            ViewData["StatusId"] = new SelectList(_context.Status, "StatusId", "JobStatus");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("JobId,JobTitle,JobDesc,StatusId,CompanyId")] Job job)
        {
            ...
            ViewData["StatusId"] = new SelectList(_context.Status, "StatusId", "JobStatus", job.StatusId);
            return View(job);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("JobId,JobTitle,JobDesc,StatusId,CompanyId")] Job job)
        {
            if (id != job.JobId)
            {
                return NotFound();
