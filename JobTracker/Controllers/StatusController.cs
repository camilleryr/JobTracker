...
namespace JobTracker.Controllers
{
    public class StatusController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("StatusId,JobStatus")] Status status)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("StatusId,JobStatus")] Status status)
        {
